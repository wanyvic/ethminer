...
#miningpoolhub.com
POOLS="$POOLS stratum1+tcp://USERNAME.WORKERNAME:WORKERPWD@asia.ethash-hub.miningpoolhub.com:20535"
POOLS="$POOLS stratum1+tcp://USERNAME.WORKERNAME:WORKERPWD@europe.ethash-hub.miningpoolhub.com:20535"
POOLS="$POOLS stratum1+tcp://USERNAME.WORKERNAME:WORKERPWD@us-east.ethash-hub.miningpoolhub.com:20535"
#nanopool.org
...
if [[ 1 == 0 ]]; then
    # replace excplicit stratum version with autodetect version
    p=""
